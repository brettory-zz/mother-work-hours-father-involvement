## prep GGS data based on: "/Users/Brett/Dropbox/Fatherinvolv_jmf_s1/revision_201116/data/code/GGS_dataprep_251116.R"
...
# loading packages
## install.packages("pacman") # pacman loads multiple packages
...
# load("between steps data saves/firstsave_011216.RData")

# load Dutch data
load("/Users/Brett/Dropbox/Fatherinvolv_jmf_s1/revise fatherinvol - ASR/data/NL/ggsnl_011216.RData")
